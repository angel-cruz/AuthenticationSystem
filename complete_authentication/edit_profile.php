        ...
        <section class="clean-block clean-form dark" style="background-image: url(&quot;assets/img/scenery/image1.jpg&quot;);background-size: cover;background-repeat: no-repeat;background-position: center;">
            <div class="container">
                ...
                <form class="text-monospace">
                    <div class="form-group"><input class="form-control" type="text" name="name" value="Varnas Spiros" placeholder="Change your name"></div>
                    <div class="form-group"><input class="form-control" type="text" name="username" value="ExampleUsername" placeholder="Change your username"></div>
                    <div class="form-group"><input class="form-control" type="email" name="email" value="user@gmail.com" placeholder="Change your email"></div>
                    <div class="form-group"><input class="form-control" type="text" name="website" value="info@example.com" placeholder="Change your website"></div>
                    <div class="form-group"><input type="file" name="profile_image"></div>
